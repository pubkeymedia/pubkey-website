...
const Home: NextPage<Props> = ({ compScreen, events }) => {
  return (
    <div className="flex flex-col items-center w-full">
      <NextSeo
        title="Welcome Home"
        description="All those other cool websites wish they could be as sweet as the PubKey homepage. It tells the story of a friend who loves video poker and dive bars. His luck isn’t very good. Care to try yours?" />
